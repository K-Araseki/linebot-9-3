    ...
    public class Callback {
        ...
        private TextMessage reply(String text) throws Exception{
            ...
            return new TextMessage(returning.get(0).getMonndai() +kaigyou_code_1
                    + "1:" + returning.get(0).getSentaku1() +kaigyou_code_1
                    + "2:" + returning.get(0).getSentaku2() +kaigyou_code_1
                    + "3:" + returning.get(0).getSentaku3() +kaigyou_code_1
                    + "4:" + returning.get(0).getSentaku4());
        }
